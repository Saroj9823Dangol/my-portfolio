...
`,date:"2024-01-15",formattedDate:"January 15, 2024",readingTime:"15 min",tags:["React","Performance","Frontend","JavaScript","React 18","Optimization","Web Development"],metaTitle:"React Performance Optimization: 2024 Master Guide",metaDescription:"Comprehensive 2024 guide to React performance optimization covering Concurrent Features, advanced memoization, component optimization, and practical implementation examples.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/react-performance-optimization-2024"},{id:"4",slug:"react-server-components-2025",title:"Dive into React Server Components in 2025 with this SEO-...",image:"/images/blogs/react-server-component.jpg",excerpt:"Dive into React Server Components in 2025 with this SEO-friendly guide, exploring server-side rendering, performance optimization, and practical examples for modern web applications.",content:`
  ...
  export default function ImageProcessor() {
    ...
    `,date:"2025-09-15",formattedDate:"September 15, 2025",readingTime:"7 min",tags:["WebAssembly","MERN Stack","React","Node.js","Performance","Web Development"],metaTitle:"WebAssembly in 2025: Boosting MERN Stack Performance",metaDescription:"Learn how WebAssembly supercharges MERN stack apps in 2025, enabling high-performance computing with React and Node.js for tasks like AI and image processing.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/WebAssembly-in-2025-Supercharging-MERN-Stack-Performance"}];function c(a){return b.find(b=>b.slug===a)}function d(){return b.sort((a,b)=>new Date(b.date).getTime()-new Date(a.date).getTime())}function e(a){let b=a.metaTitle||a.title,c=a.metaDescription||a.excerpt,d=a.canonicalUrl||`https://www.sarojdangol012.com.np/blogs/${a.slug}`,e=a.image?`https://www.sarojdangol012.com.np${a.image}`:void 0;return{title:b,description:c,authors:a.author?[{name:a.author}]:void 0,openGraph:{title:b,description:c,type:"article",url:d,images:e?[{url:e,alt:a.title}]:void 0,publishedTime:a.date,authors:a.author?[a.author]:void 0,tags:a.tags},twitter:{card:"summary_large_image",title:b,description:c,images:e?[e]:void 0},alternates:{canonical:d}}}function f(a){let b=a.canonicalUrl||`https://www.sarojdangol012.com.np/blogs/${a.slug}`,c=a.image?`https://www.sarojdangol012.com.np${a.image}`:void 0;return{"@context":"https://schema.org","@type":"BlogPosting",headline:a.title,description:a.excerpt,image:c,datePublished:a.date,dateModified:a.date,author:{"@type":"Person",name:a.author||"Saroj Dangol"},publisher:{"@type":"Person",name:"Saroj Dangol"},mainEntityOfPage:{"@type":"WebPage","@id":b},keywords:a.tags.join(", ")}}a.s(["ALL_BLOG_POSTS",0,b],49011),a.s(["generateBlogMetadata",()=>e,"generateBlogStructuredData",()=>f,"getAllBlogs",()=>d,"getBlogBySlug",()=>c],21210)}];

//# sourceMappingURL=Desktop_SD_solar-system-portfolio_app_blogs_utils_ts_34365806._.js.map