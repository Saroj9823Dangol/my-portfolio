...
`,date:"2024-01-15",formattedDate:"January 15, 2024",readingTime:"15 min",tags:["React","Performance","Frontend","JavaScript","React 18","Optimization","Web Development"],metaTitle:"React Performance Optimization: 2024 Master Guide",metaDescription:"Comprehensive 2024 guide to React performance optimization covering Concurrent Features, advanced memoization, component optimization, and practical implementation examples.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/react-performance-optimization-2024",keyTakeaways:["React.memo prevents unnecessary re-renders of functional components","useMemo and useCallback optimize expensive computations and function references","Code splitting with React.lazy reduces initial bundle size and improves load time","Virtualization libraries like react-window handle large lists efficiently","React DevTools Profiler is the essential tool for identifying performance bottlenecks"],relatedSlugs:["react-server-components-2025","mern-stack-guide-2025","nextjs-seo-best-practices"]},{id:"4",slug:"react-server-components-2025",title:"Dive into React Server Components in 2025 with this SEO-...",image:"/images/blogs/react-server-component.jpg",excerpt:"Dive into React Server Components in 2025 with this SEO-friendly guide, exploring server-side rendering, performance optimization, and practical examples for modern web applications.",content:`
  ...
  export default function ImageProcessor() {
    ...
    `,date:"2025-09-15",formattedDate:"September 15, 2025",readingTime:"7 min",tags:["WebAssembly","MERN Stack","React","Node.js","Performance","Web Development"],metaTitle:"WebAssembly in 2025: Boosting MERN Stack Performance",metaDescription:"Learn how WebAssembly supercharges MERN stack apps in 2025, enabling high-performance computing with React and Node.js for tasks like AI and image processing.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/WebAssembly-in-2025-Supercharging-MERN-Stack-Performance",keyTakeaways:["WebAssembly (WASM) enables near-native performance for computationally intensive web applications","WASM can be compiled from C, C++, Rust, and other languages for use in browsers","WebAssembly complements JavaScript rather than replacing it","WASM is ideal for video processing, gaming, cryptography, and scientific computing in browsers","The WASM ecosystem is maturing rapidly with tools like Emscripten and wasm-pack"],relatedSlugs:["react-performance-optimization-2024","mern-stack-guide-2025","aws-serverless-architecture-guide"]}];function k(){let e="https://www.sarojdangol012.com.np";return[{url:e,lastModified:new Date,changeFrequency:"weekly",priority:1},{url:`${e}/about`,lastModified:new Date,changeFrequency:"monthly",priority:.9},{url:`${e}/projects`,lastModified:new Date,changeFrequency:"monthly",priority:.8},{url:`${e}/services`,lastModified:new Date,changeFrequency:"monthly",priority:.9},{url:`${e}/contact`,lastModified:new Date,changeFrequency:"monthly",priority:.9},{url:`${e}/faq`,lastModified:new Date,changeFrequency:"monthly",priority:.8},{url:`${e}/blogs`,lastModified:new Date,changeFrequency:"weekly",priority:.9},...w.map(t=>({url:`${e}/blogs/${t.slug}`,lastModified:new Date(t.date),changeFrequency:"monthly",priority:.7}))]}e.s(["default",()=>k],34107);var x=e.i(1952);async function S(){let e=await k(),t=(0,x.resolveRouteData)(e,"sitemap");return new v.NextResponse(t,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}e.s(["GET",()=>S],14041),e.i(14041),e.i(34107),e.s(["GET",()=>S],38829);var R=e.i(38829);let j=new t.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap--route-entry",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/Desktop/SD/solar-system-portfolio/app/sitemap--route-entry.js",nextConfigOutput:"",userland:R}),{workAsyncStorage:N,workUnitAsyncStorage:C,serverHooks:E}=j;function A(){return(0,i.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:C})}async function M(e,t,i){j.isDev&&(0,r.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let v="/sitemap.xml/route";v=v.replace(/\/index$/,"")||"/";let w=await j.prepare(e,t,{srcPage:v,multiZoneDraftMode:!1});if(!w)return t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:k,params:x,nextConfig:S,parsedUrl:R,isDraftMode:N,prerenderManifest:C,routerServerContext:E,isOnDemandRevalidate:A,revalidateOnlyGenerated:M,resolvedPathname:P,clientReferenceManifest:I,serverActionsManifest:D}=w,z=(0,l.normalizeAppPath)(v),T=!!(C.dynamicRoutes[z]||C.routes[P]),B=async()=>((null==E?void 0:E.render404)?await E.render404(e,t,R,!1):t.end("This page could not be found"),null);if(T&&!N){let e=!!C.routes[P],t=C.dynamicRoutes[z];if(t&&!1===t.fallback&&!e){if(S.experimental.adapterPath)return await B();throw new b.NoFallbackError}}let F=null;!T||j.isDev||N||(F="/index"===(F=P)?"/":F);let U=!0===j.isDev||!T,O=T&&!U;D&&I&&(0,a.setReferenceManifestsSingleton)({page:v,clientReferenceManifest:I,serverActionsManifest:D,serverModuleMap:(0,s.createServerModuleMap)({serverActionsManifest:D})});let W=e.method||"GET",L=(0,n.getTracer)(),J=L.getActiveScopeSpan(),q={params:x,prerenderManifest:C,renderOpts:{experimental:{authInterrupts:!!S.experimental.authInterrupts},cacheComponents:!!S.cacheComponents,supportsDynamicResponse:U,incrementalCache:(0,r.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:S.cacheLife,waitUntil:i.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,o,i)=>j.onRequestError(e,t,i,E)},sharedContext:{buildId:k}},H=new d.NodeNextRequest(e),G=new d.NodeNextResponse(t),Y=p.NextRequestAdapter.fromNodeNextRequest(H,(0,p.signalFromNodeResponse)(t));try{let a=async e=>j.handle(Y,q).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let o=L.getRootSpanAttributes();if(!o)return;if(o.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${o.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let i=o.get("next.route");if(i){let t=`${W} ${i}`;e.setAttributes({"next.route":i,"http.route":i,"next.span_name":t}),e.updateName(t)}else e.updateName(`${W} ${v}`)}),s=!!(0,r.getRequestMeta)(e,"minimalMode"),l=async r=>{var n,l;let d=async({previousCacheEntry:o})=>{try{if(!s&&A&&M&&!o)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await a(r);e.fetchMetrics=q.renderOpts.fetchMetrics;let l=q.renderOpts.pendingWaitUntil;l&&i.waitUntil&&(i.waitUntil(l),l=void 0);let d=q.renderOpts.collectedTags;if(!T)return await (0,g.sendResponse)(H,G,n,q.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,f.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[h.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let o=void 0!==q.renderOpts.collectedRevalidate&&!(q.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&q.renderOpts.collectedRevalidate,i=void 0===q.renderOpts.collectedExpire||q.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:q.renderOpts.collectedExpire;return{value:{kind:y.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:o,expire:i}}}}catch(t){throw(null==o?void 0:o.isStale)&&await j.onRequestError(e,t,{routerKind:"App Router",routePath:v,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:A})},E),t}},p=await j.handleResponse({req:e,nextConfig:S,cacheKey:F,routeKind:o.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:C,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:M,responseGenerator:d,waitUntil:i.waitUntil,isMinimalMode:s});if(!T)return null;if((null==p||null==(n=p.value)?void 0:n.kind)!==y.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==p||null==(l=p.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",A?"REVALIDATED":p.isMiss?"MISS":p.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,f.fromNodeOutgoingHttpHeaders)(p.value.headers);return s&&T||c.delete(h.NEXT_CACHE_TAGS_HEADER),!p.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,u.getCacheControlHeader)(p.cacheControl)),await (0,g.sendResponse)(H,G,new Response(p.value.body,{headers:c,status:p.value.status||200})),null};J?await l(J):await L.withPropagatedContext(e.headers,()=>L.trace(c.BaseServerSpan.handleRequest,{spanName:`${W} ${v}`,kind:n.SpanKind.SERVER,attributes:{"http.method":W,"http.target":e.url}},l))}catch(t){if(t instanceof b.NoFallbackError||await j.onRequestError(e,t,{routerKind:"App Router",routePath:z,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:O,isOnDemandRevalidate:A})}),T)throw t;return await (0,g.sendResponse)(H,G,new Response(null,{status:500})),null}}e.s(["handler",()=>M,"patchFetch",()=>A,"routeModule",()=>j,"serverHooks",()=>E,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>C],39941)}];

//# sourceMappingURL=00ee3_next_dist_esm_build_templates_app-route_3bf7aa6e.js.map