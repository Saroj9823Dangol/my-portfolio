...
`,date:"2024-01-15",formattedDate:"January 15, 2024",readingTime:"15 min",tags:["React","Performance","Frontend","JavaScript","React 18","Optimization","Web Development"],metaTitle:"React Performance Optimization: 2024 Master Guide",metaDescription:"Comprehensive 2024 guide to React performance optimization covering Concurrent Features, advanced memoization, component optimization, and practical implementation examples.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/react-performance-optimization-2024"},{id:"4",slug:"react-server-components-2025",title:"Dive into React Server Components in 2025 with this SEO-...",image:"/images/blogs/react-server-component.jpg",excerpt:"Dive into React Server Components in 2025 with this SEO-friendly guide, exploring server-side rendering, performance optimization, and practical examples for modern web applications.",content:`
  ...
  export default function ImageProcessor() {
    ...
    `,date:"2025-09-15",formattedDate:"September 15, 2025",readingTime:"7 min",tags:["WebAssembly","MERN Stack","React","Node.js","Performance","Web Development"],metaTitle:"WebAssembly in 2025: Boosting MERN Stack Performance",metaDescription:"Learn how WebAssembly supercharges MERN stack apps in 2025, enabling high-performance computing with React and Node.js for tasks like AI and image processing.",author:"Saroj Dangol",canonicalUrl:"https://www.sarojdangol012.com.np/blogs/WebAssembly-in-2025-Supercharging-MERN-Stack-Performance"}];function c({post:e,onBack:o}){return(0,t.jsxs)(i.motion.div,{initial:{opacity:0,x:50},animate:{opacity:1,x:0},exit:{opacity:0,x:-50},className:"max-w-4xl mx-auto",children:[(0,t.jsxs)(i.motion.button,{onClick:o,className:"flex items-center gap-2 text-moon-gray font-terminal text-sm mb-6 hover:text-foreground transition-colors group",whileHover:{x:-4},children:[(0,t.jsx)(l.ArrowLeft,{size:16,className:"group-hover:-translate-x-1 transition-transform"}),"Back to all posts"]}),(0,t.jsxs)(i.motion.header,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1},className:"mb-8",children:[(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-4 mb-4 text-muted-foreground font-terminal text-sm",children:[(0,t.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,t.jsx)(r.Calendar,{size:14}),e.formattedDate||new Date(e.date).toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"})]}),(0,t.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,t.jsx)(a.Clock,{size:14}),e.readingTime]})]}),(0,t.jsx)("h1",{className:"font-display text-3xl md:text-4xl text-foreground mb-4 leading-tight",children:e.title}),(0,t.jsx)("p",{className:"font-body text-lg text-muted-foreground leading-relaxed",children:e.excerpt}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2 mt-4",children:e.tags.map(e=>(0,t.jsxs)("span",{className:"flex items-center gap-1 px-3 py-1.5 rounded-full bg-moon-gray/10 text-moon-gray font-terminal text-xs",children:[(0,t.jsx)(p.Tag,{size:10}),e]},e))}),e.image&&(0,t.jsx)(i.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},className:"mt-6 rounded-xl overflow-hidden",children:(0,t.jsx)("img",{src:e.image,alt:e.title,className:"w-full h-auto object-cover"})})]}),(0,t.jsx)(i.motion.div,{initial:{scaleX:0},animate:{scaleX:1},transition:{delay:.2},className:"h-px bg-gradient-to-r from-transparent via-moon-gray/50 to-transparent mb-8"}),(0,t.jsx)(i.motion.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.3},className:"prose prose-invert prose-moon max-w-none",children:(0,t.jsx)("div",{className:"font-body text-muted-foreground leading-relaxed",dangerouslySetInnerHTML:{__html:e.content}})}),(0,t.jsx)(i.motion.footer,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.4},className:"mt-12 pt-8 border-t border-moon-gray/20",children:(0,t.jsxs)("div",{className:"glass rounded-xl p-6 text-center",children:[e.author&&(0,t.jsxs)("p",{className:"font-terminal text-sm text-muted-foreground mb-2",children:["Written by ",e.author]}),(0,t.jsx)("p",{className:"font-terminal text-muted-foreground mb-4",children:"Enjoyed this article? Check out more posts or get in touch."}),(0,t.jsx)("button",{onClick:o,className:"px-6 py-2 bg-moon-gray/20 text-moon-gray font-terminal text-sm rounded-lg hover:bg-moon-gray/30 transition-colors",children:"View All Posts"})]})})]})}function g(){let[e,l]=(0,o.useState)(null);return(0,t.jsx)(n.AnimatePresence,{mode:"wait",children:e?(0,t.jsx)(c,{post:e,onBack:()=>l(null)},"detail"):(0,t.jsxs)(i.motion.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,x:-50},className:"max-w-4xl mx-auto",children:[(0,t.jsxs)(i.motion.div,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},className:"glass rounded-xl p-4 mb-8 flex items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)(d.Rss,{className:"text-moon-gray"}),(0,t.jsx)("span",{className:"font-terminal text-muted-foreground",children:"Satellite Feed"})]}),(0,t.jsx)("button",{className:"px-4 py-2 bg-moon-gray/10 text-moon-gray font-terminal text-sm rounded-lg hover:bg-moon-gray/20 transition-colors",children:"Subscribe to RSS"})]}),(0,t.jsx)("div",{className:"space-y-6",children:m.map((e,o)=>(0,t.jsxs)(i.motion.article,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.1*o},onClick:()=>l(e),className:"glass rounded-xl p-6 hover:border-moon-gray/50 transition-colors group cursor-pointer",children:[(0,t.jsxs)("div",{className:"flex flex-wrap items-center gap-4 mb-3 text-muted-foreground font-terminal text-sm",children:[(0,t.jsxs)("span",{className:"flex items-center gap-1",children:[(0,t.jsx)(r.Calendar,{size:14}),e.formattedDate||new Date(e.date).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})]}),(0,t.jsxs)("span",{className:"flex items-center gap-1",children:[(0,t.jsx)(a.Clock,{size:14}),e.readingTime]})]}),(0,t.jsx)("h3",{className:"font-display text-xl text-moon-gray mb-2 group-hover:text-foreground transition-colors",children:e.title}),(0,t.jsx)("p",{className:"font-body text-muted-foreground mb-4 leading-relaxed",children:e.excerpt}),(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:e.tags.map(e=>(0,t.jsx)("span",{className:"px-2 py-1 rounded-md bg-moon-gray/10 text-moon-gray font-terminal text-xs",children:e},e))}),(0,t.jsxs)("span",{className:"flex items-center gap-1 text-moon-gray font-terminal text-sm opacity-0 group-hover:opacity-100 transition-opacity",children:["Read more ",(0,t.jsx)(s.ArrowRight,{size:14})]})]})]},o))})]},"list")})}e.s(["BlogContent",()=>g],42565)}]);