export const reactNativeAppCost = {
  ...
  readingTime: "12 min", // Slightly increased for added value
  tags: [
    "react native",
    "pricing",
    "nepal",
  ...
  metaTitle:
    "React Native App Development Cost in Nepal 2026: Full Breakdown & Estimates",
  metaDescription:
    "2026 guide to React Native mobile app development costs in Nepal: simple to complex app pricing (NPR 5–80 lakhs), hourly rates, factors, timelines, and cost-saving tips for startups & businesses.",
  author: "Saroj Dangol",
  canonicalUrl:
